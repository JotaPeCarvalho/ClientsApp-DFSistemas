...
namespace ClientApp.Migrations
{
    ...
    [Migration("20230205142115_TestandoNovoBd")]
    partial class TestandoNovoBd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClientApp.Models.AdressModel", b =>
                {
                    b.HasOne("ClientApp.Models.ClientModel", "Client")
                        .WithOne("Adress")
                        .HasForeignKey("ClientApp.Models.AdressModel", "ClientId")
            ...
            modelBuilder.Entity("ClientApp.Models.PhoneModel", b =>
                {
                    b.HasOne("ClientApp.Models.ClientModel", "Client")
                        .WithOne("Phone")
                        .HasForeignKey("ClientApp.Models.PhoneModel", "ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
